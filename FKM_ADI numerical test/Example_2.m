...
alp = 0.19; beta=0.19;
AGADI_tim = tic;
[k_AGADI, ~, R_AGADI] = FKM_ADI_AB(A, B, C, alp, beta, AGADIomge, tol, maxit, X_init);
...
semilogy(R_AGADI, '-+', 'LineWidth', 1.5, 'MarkerSize', 5, 'DisplayName', ...
    'FKM\_ADI(a='+ string(alp)+', w='+ string(AGADIomge)+')');
...
fprintf('FKM_ADI: CPU time: %.4f,iteration number: %d \n', AGADI_end, k_AGADI);